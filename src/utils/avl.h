...
#ifndef	_UTILS_AVL_H_
#define	_UTILS_AVL_H_
 ...
 */
extern void avl_insert(avl_tree_t *tree, void *node,
    avl_index_t where);
 ...
 */
extern void avl_insert_here(avl_tree_t *tree, void *new_data,
 ...
 */
extern void *avl_nearest(const avl_tree_t *tree, avl_index_t where,
    int direction);
